...
public class BarcodeCam : MonoBehaviour
{
    ...
    public RawImage encodedTexture;
    public string encodeText = "http://www.google.com";
    ...
    void Start()
    {
        ...
        OnEnable();
        barcodeReader = new BarcodeReader { AutoRotate = true, Options = new ZXing.Common.DecodingOptions { TryHarder = true } };
    ...
    void Update()
    {
            ...
            textForEncoding != null)
        {
            ...
            encoded.Apply();
            encodedTexture.texture = encoded;
